...
// func (f *fakeTransactionManager) WithTransaction(ctx context.Context, fn func(stores *repository.PostgresStores) error) error {
// 	f.called = true
// 	if f.err != nil {
// 		return f.err
// 	}
...
// // GetTransactionBySessionID implements [Repository].
// func (f *fakeRepository) GetTransactionBySessionID(ctx context.Context, sessionID string) (*domain.Transaction, error) {
// 	panic("unimplemented")
// }
...
// 	return NewLegerService(txManager, nil, testValidator(), testLogger())
// }
